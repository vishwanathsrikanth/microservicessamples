...
export class MsalService {
    ...
    tenantConfig = {
        tenant: "tinytotsb2c.onmicrosoft.com",
        // Replace this with your client id 
        clientID: 'd9d9a6cd-f12c-4731-a57c-9e1420826853',
        signInPolicy: "B2C_1_signin",
        signUpPolicy: "B2C_1_signup",
        redirectUri:"http://localhost:4200",
        b2cScopes:["https://tinytotsb2c.onmicrosoft.com/access-api/user_impersonation"]
    };
